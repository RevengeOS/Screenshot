.class public Lcom/android/screenshot/anim/AnimatorInflater;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/screenshot/anim/AnimatorInflater;->TARGET_ANIM_MAP:Ljava/util/Map;

    .line 60
    sget-object v0, Lcom/android/screenshot/anim/AnimatorInflater;->TARGET_ANIM_MAP:Ljava/util/Map;
...
.method private static addTarget(Landroid/content/Context;Landroid/util/AttributeSet;Lcom/android/screenshot/anim/TargetAnimator;)V
    .locals 17
    .param p0, "context"    # Landroid/content/Context;
    .param p1, "attrs"    # Landroid/util/AttributeSet;
    .param p2, "anim"    # Lcom/android/screenshot/anim/TargetAnimator;
    ...
    sget-object v2, Lcom/android/screenshot/R$styleable;->Target:[I
    ...
    .line 355
    invoke-virtual/range {p2 .. p2}, Lcom/android/screenshot/anim/TargetAnimator;->getLoader()Lcom/android/screenshot/anim/TargetAnimator$ViewLoader;

    move-result-object v7

    invoke-interface {v7, v6}, Lcom/android/screenshot/anim/TargetAnimator$ViewLoader;->findViewById(I)Landroid/view/View;
    ...
    .line 360
    new-instance v7, Lcom/android/screenshot/anim/TargetAnimator$TargetProp;

    invoke-direct {v7}, Lcom/android/screenshot/anim/TargetAnimator$TargetProp;-><init>()V

    .line 361
    .local v7, "propAnimators":Lcom/android/screenshot/anim/TargetAnimator$TargetProp;
    new-instance v8, Lcom/android/screenshot/anim/TargetAnimator$TargetProp;

    invoke-direct {v8}, Lcom/android/screenshot/anim/TargetAnimator$TargetProp;-><init>()V

    .line 362
    .local v8, "propStarts":Lcom/android/screenshot/anim/TargetAnimator$TargetProp;
    new-instance v9, Lcom/android/screenshot/anim/TargetAnimator$TargetProp;

    invoke-direct {v9}, Lcom/android/screenshot/anim/TargetAnimator$TargetProp;-><init>()V

    .line 363
    .local v9, "propEnds":Lcom/android/screenshot/anim/TargetAnimator$TargetProp;
    ...
    .line 383
    .local v13, "resID":I
    invoke-static {v0, v13}, Lcom/android/screenshot/anim/InterpolatorUtils;->loadInterpolator(Landroid/content/Context;I)Landroid/view/animation/Interpolator;

    move-result-object v14

    .line 384
    .local v14, "interpolator":Landroid/view/animation/Interpolator;
    sget-object v15, Lcom/android/screenshot/anim/AnimatorInflater;->TARGET_ANIM_MAP:Ljava/util/Map;
    ...
    invoke-virtual {v7, v5, v14}, Lcom/android/screenshot/anim/TargetAnimator$TargetProp;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v9, v13, v14}, Lcom/android/screenshot/anim/TargetAnimator$TargetProp;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v8, v14, v15}, Lcom/android/screenshot/anim/TargetAnimator$TargetProp;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .end local v11    # "i":I
    :cond_1
    invoke-virtual {v1, v4, v7}, Lcom/android/screenshot/anim/TargetAnimator;->addPropAnimator(Landroid/view/View;Lcom/android/screenshot/anim/TargetAnimator$TargetProp;)V

    .line 392
    invoke-virtual {v1, v4, v8}, Lcom/android/screenshot/anim/TargetAnimator;->addPropStart(Landroid/view/View;Lcom/android/screenshot/anim/TargetAnimator$TargetProp;)V

    .line 393
    invoke-virtual {v1, v4, v9}, Lcom/android/screenshot/anim/TargetAnimator;->addPropEnd(Landroid/view/View;Lcom/android/screenshot/anim/TargetAnimator$TargetProp;)V

    .line 396
    .end local v7    # "propAnimators":Lcom/android/screenshot/anim/TargetAnimator$TargetProp;
    .end local v8    # "propStarts":Lcom/android/screenshot/anim/TargetAnimator$TargetProp;
    .end local v9    # "propEnds":Lcom/android/screenshot/anim/TargetAnimator$TargetProp;
    .end local v10    # "N":I
    :cond_2
...
.method private static createAnimatorFromXml(Landroid/content/Context;Lcom/xmlpull/v1/XmlPullParser;Lcom/android/screenshot/anim/TargetAnimator$ViewLoader;Landroid/util/AttributeSet;Landroid/animation/AnimatorSet;I)Landroid/animation/Animator;
    ...
    .line 129
    invoke-static {v6, v7}, Lcom/android/screenshot/anim/AnimatorInflater;->loadObjectAnimator(Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/animation/ObjectAnimator;
    ...
    invoke-static {v6, v7, v1}, Lcom/android/screenshot/anim/AnimatorInflater;->loadAnimator(Landroid/content/Context;Landroid/util/AttributeSet;Landroid/animation/ValueAnimator;)Landroid/animation/ValueAnimator;
    ...
    invoke-static {v6, v7, v1}, Lcom/android/screenshot/anim/AnimatorInflater;->loadTargetAnimator(Landroid/content/Context;Landroid/util/AttributeSet;Lcom/android/screenshot/anim/TargetAnimator$ViewLoader;)Lcom/android/screenshot/anim/TargetAnimator;
    ...
    check-cast v2, Lcom/android/screenshot/anim/TargetAnimator;

    invoke-static {v6, v7, v2}, Lcom/android/screenshot/anim/AnimatorInflater;->addTarget(Landroid/content/Context;Landroid/util/AttributeSet;Lcom/android/screenshot/anim/TargetAnimator;)V
...
.method private static createTargetAnimator(Landroid/content/Context;Ljava/lang/String;Lcom/android/screenshot/anim/TargetAnimator$ViewLoader;)Lcom/android/screenshot/anim/TargetAnimator;
    .locals 4
    .param p0, "context"    # Landroid/content/Context;
    ...
    .line 401
    .local v0, "anim":Lcom/android/screenshot/anim/TargetAnimator;
    if-eqz p1, :cond_0
    ...
    const-class v2, Lcom/android/screenshot/anim/TargetAnimator;
    ...
    .line 405
    .local v1, "clazz":Ljava/lang/Class;, "Ljava/lang/Class<+Lcom/android/screenshot/anim/TargetAnimator;>;"
    const/4 v2, 0x0
    ...
    .line 407
    .local v3, "constructor":Ljava/lang/reflect/Constructor;, "Ljava/lang/reflect/Constructor<+Lcom/android/screenshot/anim/TargetAnimator;>;"
    ...
    .line 420
    .end local v1    # "clazz":Ljava/lang/Class;, "Ljava/lang/Class<+Lcom/android/screenshot/anim/TargetAnimator;>;"
    .end local v3    # "constructor":Ljava/lang/reflect/Constructor;, "Ljava/lang/reflect/Constructor<+Lcom/android/screenshot/anim/TargetAnimator;>;"
    :goto_0
    goto :goto_1
    ...
    .line 423
    :cond_0
    new-instance v1, Lcom/android/screenshot/anim/TargetAnimator;

    invoke-direct {v1}, Lcom/android/screenshot/anim/TargetAnimator;-><init>()V

    move-object v0, v1

    .line 425
    :goto_1
    invoke-virtual {v0, p2}, Lcom/android/screenshot/anim/TargetAnimator;->setLoader(Lcom/android/screenshot/anim/TargetAnimator$ViewLoader;)V
...
.method public static loadAnimator(Landroid/content/Context;I)Landroid/animation/Animator;
    ...
    invoke-static {p0, p1, v0}, Lcom/android/screenshot/anim/AnimatorInflater;->loadAnimator(Landroid/content/Context;ILcom/android/screenshot/anim/TargetAnimator$ViewLoader;)Landroid/animation/Animator;
...
.method public static loadAnimator(Landroid/content/Context;ILcom/android/screenshot/anim/TargetAnimator$ViewLoader;)Landroid/animation/Animator;
    .locals 5
    .param p0, "context"    # Landroid/content/Context;
    .param p1, "id"    # I
    .param p2, "loader"    # Lcom/android/screenshot/anim/TargetAnimator$ViewLoader;
...
.method private static loadAnimator(Landroid/content/Context;Landroid/util/AttributeSet;Landroid/animation/ValueAnimator;)Landroid/animation/ValueAnimator;
    ...
    .line 327
    invoke-static {v0, v3}, Lcom/android/screenshot/anim/InterpolatorUtils;->loadInterpolator(Landroid/content/Context;I)Landroid/view/animation/Interpolator;
...
.method private static loadObjectAnimator(Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/animation/ObjectAnimator;
    ...
    invoke-static {p0, p1, v0}, Lcom/android/screenshot/anim/AnimatorInflater;->loadAnimator(Landroid/content/Context;Landroid/util/AttributeSet;Landroid/animation/ValueAnimator;)Landroid/animation/ValueAnimator;
...
.method private static loadTargetAnimator(Landroid/content/Context;Landroid/util/AttributeSet;Lcom/android/screenshot/anim/TargetAnimator$ViewLoader;)Lcom/android/screenshot/anim/TargetAnimator;
    .locals 2
    .param p0, "context"    # Landroid/content/Context;
    .param p1, "attrs"    # Landroid/util/AttributeSet;
    .param p2, "loader"    # Lcom/android/screenshot/anim/TargetAnimator$ViewLoader;
    ...
    invoke-static {p0, v0, p2}, Lcom/android/screenshot/anim/AnimatorInflater;->createTargetAnimator(Landroid/content/Context;Ljava/lang/String;Lcom/android/screenshot/anim/TargetAnimator$ViewLoader;)Lcom/android/screenshot/anim/TargetAnimator;

    move-result-object v1

    .line 341
    .local v1, "anim":Lcom/android/screenshot/anim/TargetAnimator;
    invoke-static {p0, p1, v1}, Lcom/android/screenshot/anim/AnimatorInflater;->loadAnimator(Landroid/content/Context;Landroid/util/AttributeSet;Landroid/animation/ValueAnimator;)Landroid/animation/ValueAnimator;
