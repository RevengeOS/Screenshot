.class public Lcom/android/screenshot/util/Utils;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/screenshot/util/Utils;->WATER_MARK:Landroid/graphics/Bitmap;
...
.method public static addWatermark(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    .line 409
    .local v1, "hight":I
    invoke-static {v0, v1}, Lcom/android/screenshot/util/Utils;->genWaterMark(II)Landroid/graphics/Bitmap;
...
.method public static addWatermarkForLongshot(Landroid/graphics/Bitmap;Landroid/content/Context;)V
    ...
    .line 438
    .local v4, "hight":I
    invoke-static {v3, v4}, Lcom/android/screenshot/util/Utils;->genWaterMark(II)Landroid/graphics/Bitmap;
...
.method private static genWaterMark(II)Landroid/graphics/Bitmap;
    ...
    sget v4, Lcom/android/screenshot/longshot/util/Configs;->WATERMARK_TIMES:I
    ...
    sget-object v7, Lcom/android/screenshot/longshot/util/Configs;->IMEI_NUMBER:Ljava/lang/String;
    ...
    sput-object v1, Lcom/android/screenshot/util/Utils;->WATER_MARK:Landroid/graphics/Bitmap;

    .line 386
    invoke-virtual {v0}, Landroid/graphics/Bitmap;->recycle()V

    .line 388
    sget-object v1, Lcom/android/screenshot/util/Utils;->WATER_MARK:Landroid/graphics/Bitmap;
...
.method public static saveToFile(Landroid/content/Context;Lcom/android/screenshot/util/FileInfo;Landroid/graphics/Bitmap;)Z
    .locals 28
    .param p0, "context"    # Landroid/content/Context;
    .param p1, "fileInfo"    # Lcom/android/screenshot/util/FileInfo;
    ...
    :try_start_0
    invoke-virtual/range {p1 .. p1}, Lcom/android/screenshot/util/FileInfo;->getName()Ljava/lang/String;
    ...
    invoke-virtual/range {p1 .. p1}, Lcom/android/screenshot/util/FileInfo;->getPath()Ljava/lang/String;
    ...
    invoke-virtual/range {p1 .. p1}, Lcom/android/screenshot/util/FileInfo;->getTime()J
    ...
    invoke-static {v0, v5, v11}, Lcom/android/screenshot/Native;->doencrypt(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
    ...
    :try_start_7
    invoke-virtual {v5, v0}, Lcom/android/screenshot/util/FileInfo;->setUri(Landroid/net/Uri;)V
