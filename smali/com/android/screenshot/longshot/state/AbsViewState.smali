.class public abstract Lcom/android/screenshot/longshot/state/AbsViewState;
.super Lcom/android/screenshot/longshot/state/BaseState;
.source "AbsViewState.java"

# interfaces
.implements Lcom/android/screenshot/longshot/app/LongshotDialog$OnShowListener;
...
.method protected initContent(Landroid/widget/FrameLayout;)V
    ...
    .line 43
    invoke-virtual {p0, p1}, Lcom/android/screenshot/longshot/state/AbsViewState;->clearContentBackground(Landroid/widget/FrameLayout;)V
...
.method protected initDecor(Landroid/widget/FrameLayout;)V
    ...
    .line 39
    invoke-virtual {p0, p1}, Lcom/android/screenshot/longshot/state/AbsViewState;->clearDecorForeground(Landroid/widget/FrameLayout;)V
...
.method public onShow(Landroid/app/Dialog;)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/screenshot/longshot/state/AbsViewState;->initDecor(Landroid/widget/FrameLayout;)V
    ...
    invoke-virtual {p0, v1}, Lcom/android/screenshot/longshot/state/AbsViewState;->initContent(Landroid/widget/FrameLayout;)V

    .line 32
    invoke-virtual {p0, v1}, Lcom/android/screenshot/longshot/state/AbsViewState;->initViews(Landroid/widget/FrameLayout;)V
