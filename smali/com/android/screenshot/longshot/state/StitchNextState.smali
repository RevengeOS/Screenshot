.class public Lcom/android/screenshot/longshot/state/StitchNextState;
...
.method protected createJoinTask()Lcom/android/screenshot/longshot/task/JoinTask;
    ...
    .line 25
    new-instance v0, Lcom/android/screenshot/longshot/task/StitchNextTask;

    iget-object v1, p0, Lcom/android/screenshot/longshot/state/StitchNextState;->mJoinCache:Lcom/android/screenshot/longshot/cache/JoinCache;

    iget-object v2, p0, Lcom/android/screenshot/longshot/state/StitchNextState;->mStateContext:Lcom/android/screenshot/longshot/state/LongshotContext;

    invoke-interface {v2}, Lcom/android/screenshot/longshot/state/LongshotContext;->getContext()Landroid/content/Context;

    move-result-object v2

    iget-object v3, p0, Lcom/android/screenshot/longshot/state/StitchNextState;->mStateContext:Lcom/android/screenshot/longshot/state/LongshotContext;

    invoke-interface {v3}, Lcom/android/screenshot/longshot/state/LongshotContext;->getIndex()I

    move-result v3

    invoke-direct {v0, p0, v1, v2, v3}, Lcom/android/screenshot/longshot/task/StitchNextTask;-><init>(Lcom/android/screenshot/longshot/task/JoinTask$OnJoinListener;Lcom/android/screenshot/longshot/cache/JoinCache;Landroid/content/Context;I)V
...
.method protected getFailedText()Ljava/lang/String;
    ...
    .line 36
    invoke-virtual {p0}, Lcom/android/screenshot/longshot/state/StitchNextState;->getErrorText()Ljava/lang/String;
    ...
    .line 38
    :cond_0
    invoke-virtual {p0}, Lcom/android/screenshot/longshot/state/StitchNextState;->getPageText()Ljava/lang/String;
...
.method protected getPageText()Ljava/lang/String;
    ...
    .line 67
    iget-object v0, p0, Lcom/android/screenshot/longshot/state/StitchNextState;->mJoinCache:Lcom/android/screenshot/longshot/cache/JoinCache;
...
.method protected getStateOnFailed()Lcom/android/screenshot/longshot/state/LongshotState;
    ...
    .line 52
    iget-object v0, p0, Lcom/android/screenshot/longshot/state/StitchNextState;->mStateContext:Lcom/android/screenshot/longshot/state/LongshotContext;
    ...
    sget-boolean v0, Lcom/android/screenshot/longshot/util/Configs;->NOT_IGNORE_FAIL:Z
    ...
    invoke-virtual {v0}, Lcom/android/screenshot/longshot/cache/JoinCache;->removeLast()Ljava/lang/Object;
