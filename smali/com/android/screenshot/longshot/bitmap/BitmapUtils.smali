.class public Lcom/android/screenshot/longshot/bitmap/BitmapUtils;
...
.method public static createPreview(Ljava/util/List;I)Landroid/graphics/Bitmap;
    ...
    .line 137
    .local p0, "bitmaps":Ljava/util/List;, "Ljava/util/List<Landroid/graphics/Bitmap;>;"
    invoke-static {p0}, Lcom/android/screenshot/longshot/bitmap/BitmapUtils;->getImageHeight(Ljava/util/List;)I
    ...
    .line 141
    :cond_0
    invoke-static {p0}, Lcom/android/screenshot/longshot/bitmap/BitmapUtils;->getImageWidth(Ljava/util/List;)I
    ...
    .local v3, "cutSize":I
    :goto_0
    invoke-static {p0}, Lcom/android/screenshot/longshot/bitmap/BitmapUtils;->getImageConfig(Ljava/util/List;)Landroid/graphics/Bitmap$Config;
...
.method public static drawBitmaps(Ljava/util/List;IIIILandroid/graphics/Canvas;Landroid/graphics/Bitmap$Config;)V
    ...
    invoke-static {v7, v1, v6}, Lcom/android/screenshot/longshot/bitmap/BitmapUtils;->hasDivider(III)Z
    ...
    invoke-static/range {v9 .. v14}, Lcom/android/screenshot/longshot/bitmap/BitmapUtils;->drawDivider(IIIZLandroid/graphics/Canvas;Landroid/graphics/Bitmap$Config;)I
...
.method private static drawDivider(IIIZLandroid/graphics/Canvas;Landroid/graphics/Bitmap$Config;)I
    ...
    .line 172
    sget v2, Lcom/android/screenshot/longshot/dump/BitmapDumper;->DIV_COLOR:I
...
.method public static joinBitmaps(ILjava/util/List;)Landroid/graphics/Bitmap;
    ...
    .line 89
    :try_start_0
    invoke-static {p1}, Lcom/android/screenshot/longshot/bitmap/BitmapUtils;->getImageWidth(Ljava/util/List;)I

    move-result v3

    .line 90
    .local v3, "width":I
    invoke-static {p1}, Lcom/android/screenshot/longshot/bitmap/BitmapUtils;->getImageHeight(Ljava/util/List;)I
    ...
    .local v11, "height":I
    invoke-static {p1}, Lcom/android/screenshot/longshot/bitmap/BitmapUtils;->getImageConfig(Ljava/util/List;)Landroid/graphics/Bitmap$Config;
    ...
    invoke-static/range {v4 .. v10}, Lcom/android/screenshot/longshot/bitmap/BitmapUtils;->drawBitmaps(Ljava/util/List;IIIILandroid/graphics/Canvas;Landroid/graphics/Bitmap$Config;)V
...
.method public static varargs joinBitmaps(I[Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    invoke-static {p0, v0}, Lcom/android/screenshot/longshot/bitmap/BitmapUtils;->joinBitmaps(ILjava/util/List;)Landroid/graphics/Bitmap;
...
.method public static joinBitmaps(Ljava/util/List;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v0, p0}, Lcom/android/screenshot/longshot/bitmap/BitmapUtils;->joinBitmaps(ILjava/util/List;)Landroid/graphics/Bitmap;
...
.method public static varargs joinBitmaps([Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v0, p0}, Lcom/android/screenshot/longshot/bitmap/BitmapUtils;->joinBitmaps(I[Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
...
.method public static pickBitmaps(Ljava/util/List;Ljava/util/List;)V
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            ...
            ">;",
            "Ljava/util/List<",
            "Lcom/android/screenshot/longshot/cache/BitmapCache;",
            ">;)V"
        }
    .end annotation
    ...
    .line 121
    .local p0, "bitmaps":Ljava/util/List;, "Ljava/util/List<Landroid/graphics/Bitmap;>;"
    .local p1, "caches":Ljava/util/List;, "Ljava/util/List<Lcom/android/screenshot/longshot/cache/BitmapCache;>;"
    ...
    check-cast v1, Lcom/android/screenshot/longshot/cache/BitmapCache;

    .line 122
    .local v1, "cache":Lcom/android/screenshot/longshot/cache/BitmapCache;
    invoke-virtual {v1}, Lcom/android/screenshot/longshot/cache/BitmapCache;->getTop()Landroid/graphics/Bitmap;
    ...
    .line 125
    :cond_0
    invoke-virtual {v1}, Lcom/android/screenshot/longshot/cache/BitmapCache;->getBitmap()Landroid/graphics/Bitmap;
    ...
    .line 126
    invoke-virtual {v1}, Lcom/android/screenshot/longshot/cache/BitmapCache;->getBottom()Landroid/graphics/Bitmap;
    ...
    .line 129
    .end local v1    # "cache":Lcom/android/screenshot/longshot/cache/BitmapCache;
    :cond_1
    goto :goto_0
