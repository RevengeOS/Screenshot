.class public abstract Lorg/pixelexperience/screenshot/longshot/state/AbsImageState;
...
.field protected mImageView:Lorg/pixelexperience/screenshot/longshot/widget/ImageView;
...
.method public constructor <init>(Lorg/pixelexperience/screenshot/longshot/state/LongshotContext;)V
    ...
    iput-object v0, p0, Lorg/pixelexperience/screenshot/longshot/state/AbsImageState;->mImageCache:Lorg/pixelexperience/screenshot/longshot/cache/ImageCache;

    .line 17
    iput-object v0, p0, Lorg/pixelexperience/screenshot/longshot/state/AbsImageState;->mImageView:Lorg/pixelexperience/screenshot/longshot/widget/ImageView;

    .line 24
    iget-object v0, p0, Lorg/pixelexperience/screenshot/longshot/state/AbsImageState;->mStateContext:Lorg/pixelexperience/screenshot/longshot/state/LongshotContext;
...
.method public exit(Lorg/pixelexperience/screenshot/longshot/state/LongshotState;)V
    ...
    .line 38
    iget-object v0, p0, Lorg/pixelexperience/screenshot/longshot/state/AbsImageState;->mImageCache:Lorg/pixelexperience/screenshot/longshot/cache/ImageCache;
...
.method protected initViews(Landroid/widget/FrameLayout;)V
    ...
    check-cast v0, Lorg/pixelexperience/screenshot/longshot/widget/ImageView;

    .line 46
    .local v0, "imageView":Lorg/pixelexperience/screenshot/longshot/widget/ImageView;
    iget-object v1, p0, Lorg/pixelexperience/screenshot/longshot/state/AbsImageState;->mStateContext:Lorg/pixelexperience/screenshot/longshot/state/LongshotContext;

    invoke-interface {v1}, Lorg/pixelexperience/screenshot/longshot/state/LongshotContext;->getNavBarHeight()I

    move-result v1

    invoke-virtual {v0, v1}, Lorg/pixelexperience/screenshot/longshot/widget/ImageView;->setNavBarHeight(I)V

    .line 47
    iget-object v1, p0, Lorg/pixelexperience/screenshot/longshot/state/AbsImageState;->mImageCache:Lorg/pixelexperience/screenshot/longshot/cache/ImageCache;

    invoke-virtual {v0, v1}, Lorg/pixelexperience/screenshot/longshot/widget/ImageView;->setBitmaps(Ljava/util/List;)V

    .line 49
    .end local v0    # "imageView":Lorg/pixelexperience/screenshot/longshot/widget/ImageView;
    :cond_0
    return-void
.end method
